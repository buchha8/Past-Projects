Abandoned prototype for ergonomic mouse+keyboard control using facial tracking.

I was able to find a facial tracking model that works pretty well, but I quickly found critical problems with the facial landmarking model:
